...
export const countries: Country[] = [
  ...
  },
  {
    ...
    code: "JO",
    flag: "🇯🇴",
    description: "Air, sea and land cargo to Amman and Aqaba with fast customs clearance and door-to-door delivery.",
    services: ["Air Cargo", "Sea Cargo", "Land Cargo"],
    priority: true,
  },
  {
    ...
    code: "SY",
    flag: "🇸🇾",
    description: "Reliable air, sea and overland cargo to Damascus, Aleppo and Latakia with full customs handling.",
    services: ["Air Cargo", "Sea Cargo", "Land Cargo"],
    priority: true,
  },
  {
    ...
    code: "LB",
    flag: "🇱🇧",
    description: "Direct air and sea cargo to Beirut with expert customs clearance and dependable delivery.",
    services: ["Air Cargo", "Sea Cargo", "Land Cargo"],
    priority: true,
  },
  {
